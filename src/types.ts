...
export const METHOD_LIST: MethodMeta[] = [
  {
    key: "hotCold",
    name: "冷热杀号法",
    desc: "只杀冷号！热号下期75%概率继续出不能杀。当前遗漏≥55%历史最大遗漏的冷号，继续遗漏概率高，可杀。",
  },
  {
    key: "limit",
    name: "极限杀号法",
    desc: "不杀连开号！连开号有延续性。只杀'刚断连开+遗漏1-4期'的号 — 热完冷却中，下期大概率不出。",
  },
  {
    key: "headTail",
    name: "首尾球差法",
    desc: "上期首尾号相减的差值，下期普遍绝杀（形态逻辑）；若差值在本期已出现则保留。",
  },
  {
    key: "omit",
    name: "遗漏值法",
    desc: "当前遗漏≥历史最大遗漏70%的号 — 持续冷态可能继续冷，可杀。",
  },
  {
    key: "repeat",
    name: "重号排除法（反向）",
    desc: "上期5个号有75%概率继续出→保护不杀。在剩下6个非重号中，遗漏排名前3的可杀（非重号中最冷的）。",
  },
  {
    key: "neighbor",
    name: "邻号远离杀号法",
    desc: "距离上期所有号码差距≥2的孤立号，出现概率低（邻号±1是11选5主流形态），可杀。",
  },
  {
    key: "sum",
    name: "和值极值杀号法",
    desc: "最近3期和值连续偏大→杀大号（≥9），连续偏小→杀小号（≤3），均值回归逻辑。",
  },
  {
    key: "parity",
    name: "奇偶/大小/质合反向杀",
    desc: "近3期连续偏奇→反向杀奇；连续偏大→反向杀大。均值回归：偏太久会反弹。",
  },
  {
    key: "road",
    name: "012路过热杀法",
    desc: "0路(3,6,9)/1路(1,4,7,10)/2路(2,5,8,11)，某路近期出现远超理论值→该路号可杀。",
  },
  {
    key: "span",
    name: "跨度方向杀法",
    desc: "近3期跨度都≤6（偏小）→杀大号(≥8)；跨度都≥9（偏大）→杀小号(≤4)。跨度9/8是最常见值。",
  },
  {
    key: "ac",
    name: "AC值贡献杀法",
    desc: "AC值是组合复杂度指标。对组合复杂度贡献最低的号（加上后不增加差值多样性）→不太可能出→杀。",
  },
  {
    key: "tail",
    name: "尾数冷杀法",
    desc: "近10期尾数0-9中，连续5期以上没出的尾数称为冷尾。冷尾对应的号→可杀。",
  },
];
